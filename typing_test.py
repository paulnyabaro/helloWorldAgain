...
pyautogui.typewrite(f'{text_1}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_2}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_3}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_4}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_5}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_6}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_1}',0.001)
pyautogui.press('enter')
pyautogui.typewrite(f'{text_2}',0.001)
